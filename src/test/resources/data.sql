...
VALUES ('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'System Administrator', 'admin@fincore.com', '+1234567890', 'EMP001', 'IT', 'System Admin', 'ACTIVE', 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Insert compliance officer user (password: Compliance@123)
INSERT INTO users (username, password, full_name, email, phone_number, employee_id, department, job_title, status, role_id, failed_login_attempts, created_at, updated_at) 
VALUES ('compliance', '$2a$10$8EjkXagFHB.7fD8YfBkJ9e4kU5YwFZT5JhkqjTqG0XYqZ5Z5Z5Z5Z', 'Compliance Officer', 'compliance@fincore.com', '+1234567891', 'EMP002', 'Compliance', 'Compliance Officer', 'ACTIVE', 2, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Insert operational staff user (password: Staff@123456)
INSERT INTO users (username, password, full_name, email, phone_number, employee_id, department, job_title, status, role_id, failed_login_attempts, created_at, updated_at) 
VALUES ('staff', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Operational Staff', 'staff@fincore.com', '+1234567892', 'EMP003', 'Operations', 'Staff Member', 'ACTIVE', 3, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
