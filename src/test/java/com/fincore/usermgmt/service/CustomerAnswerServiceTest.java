...
public class CustomerAnswerServiceTest {
    ...
    void testSaveAnswer_NewAnswer() {
        when(questionnaireService.getQuestionById(1))
        ...
        assertEquals("Software Engineer", result.getAnswer());
    ...
    void testGetAnswersByUser() {
        ...
        verify(answerRepository, times(1)).findByUser_Id(1L);
    }
    ...
    void testGetAnswerByUserAndQuestion() {
        ...
        verify(answerRepository, times(1)).findByUser_IdAndQuestion_QuestionId(1L, 1);
    }
    ...
    void testUpdateAnswer() {
        ...
        updated.setAnswer("Updated: Software Engineer");
        ...
        assertEquals("Updated: Software Engineer", result.getAnswer());
        verify(answerRepository, times(1)).save(any());
    }
    ...
    void testHasAnswered_False() {
        when(answerRepository.findByUser_IdAndQuestion_QuestionId(anyLong(), anyInt()))
                .thenReturn(Optional.empty());
    ...
    void testGetAnswerCompletionRate() {
        List<CustomerAnswer> answers = Arrays.asList(
                CustomerAnswer.builder().answerId(1L).answer("Answer 1").build(),
    ...
    void testSaveAnswersBulk() {
        ...
        when(questionnaireService.getQuestionById(anyInt()))
                .thenReturn(testQuestion);
        when(answerRepository.findByUser_IdAndQuestion_QuestionId(anyLong(), anyInt()))
                .thenReturn(Optional.empty());
        when(answerRepository.save(any()))
    ...
    void testGetAnswersByQuestion() {
        ...
        when(answerRepository.findByQuestion_QuestionId(1))
