...
INSERT INTO users (username, password, full_name, email, phone_number, employee_id, department, job_title, status, role_id, failed_login_attempts, created_at, updated_at) 
VALUES ('compliance', '$2a$10$1My2JRg0A4A0PGwzalpd2efAY3Evz87X3CQSQ9SrvExqQSj6.E7O.', 'Compliance Officer', 'compliance@fincore.com', '+1234567891', 'EMP002', 'Compliance', 'Compliance Officer', 'ACTIVE', 3, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Insert operational staff user (password: Staff@123456)
INSERT INTO users (username, password, full_name, email, phone_number, employee_id, department, job_title, status, role_id, failed_login_attempts, created_at, updated_at) 
VALUES ('staff', '$2a$10$OHPlw5KVcthAjlsaDwzRmueQMvzxEVfnPt2KcT52cmYciyW6KijdC', 'Operational Staff', 'staff@fincore.com', '+1234567892', 'EMP003', 'Operations', 'Staff Member', 'ACTIVE', 4, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
